            ...
            components: [
                ...
                TreeView.ExpandButton({
                    ...
                    components: [
                        ...
                        new Label({ markdownText: "4) Ввести в поле: **Проверочный код** 5-ти значный код, который должен прийти в **Telegram** (3)", wordBreak: "break-all", width: Styles.WIDTH.WEBKIT_FILL }),
